...
from com.sun.star.awt.MessageBoxType import MESSAGEBOX  # type: ignore
from com.sun.star.awt import XWindowPeer  # type: ignore
from com.sun.star.awt import XMessageBoxFactory  # type: ignore


class MessageDialog(DialogBase):
    """Shows message in standard message box."""

    def __init__(self, ctx: Any, parent: XWindowPeer | None = None, **kwargs) -> None:  # noqa: ANN003, ANN401
        """
        Constructor
